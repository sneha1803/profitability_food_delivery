...
-- Separate out the Discount type and Discount Amount from Discounts_and_Offers coulumn--
...
-- SELECT Customer_ID, COUNT(*) AS Repeat_Orders FROM food_orders GROUP BY Customer_ID ORDER BY COUNT(*) DESC;
-- Since, no. of rows returned is 947, thus we have 51 Repeat Customers w/ 2  of them having ordered thrice and the rest of them having ordered twice

-- Order these by how many used the new users discount
-- SELECT * FROM food_orders WHERE Discount_Type LIKE 'NEW USER';
